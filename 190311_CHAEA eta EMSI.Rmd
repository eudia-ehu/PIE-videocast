---
title: "CHAEA eta EMSI galdetegietako erantzunen txostena"
author: "Juan Abasolo"
date: "r `Sys.Date()`"
output:
  html_document:
...
```{r}
kruskal.test(df.itemak.emsi[, mintrinseca[1]]~df.emsi$Faku)
kruskal.test(df.itemak.emsi[, mintrinseca[2]]~df.emsi$Faku)
pairwise.wilcox.test(x = as.numeric(df.itemak.emsi[, mintrinseca[2]]), 
                     g = df.emsi$Faku, 
                     p.adjust.method = "holm")
kruskal.test(df.itemak.emsi[, mintrinseca[3]]~df.emsi$Faku)
pairwise.wilcox.test(x = as.numeric(df.itemak.emsi[, mintrinseca[3]]), 
                     g = df.emsi$Faku, 
                     p.adjust.method = "holm")
kruskal.test(df.itemak.emsi[, mintrinseca[4]]~df.emsi$Faku)
```

Kruskal-Wallisen testak emaitz adierazgarria erakusten duenean, elementuen arteko konparazio bitarra egin behar da, Mann-Withney-Wilcoxon'en U testa erabilita.

pairwise.wilcox.test() edo pgirmess::kruskalmc()
...
kruskal.test(df.itemak.emsi[, mregulacionidentificada[1]]~df.emsi$Faku)
kruskal.test(df.itemak.emsi[, mregulacionidentificada[2]]~df.emsi$Faku)
kruskal.test(df.itemak.emsi[, mregulacionidentificada[3]]~df.emsi$Faku)
car::leveneTest(as.numeric(df.itemak.emsi[, mregulacionidentificada[4]])~df.emsi$Faku, center = "median")
kruskal.test(df.itemak.emsi[, mregulacionidentificada[4]]~df.emsi$Faku)
pairwise.wilcox.test(x = as.numeric(df.itemak.emsi[, mregulacionidentificada[4]]), 
                     g = df.emsi$Faku, 
                     p.adjust.method = "holm")
```
...
kruskal.test(df.itemak.emsi[, mregulacionexterna[1]]~df.emsi$Faku)
kruskal.test(df.itemak.emsi[, mregulacionexterna[2]]~df.emsi$Faku)
kruskal.test(df.itemak.emsi[, mregulacionexterna[3]]~df.emsi$Faku)
kruskal.test(df.itemak.emsi[, mregulacionexterna[4]]~df.emsi$Faku)
...
```{r}
kruskal.test(df.itemak.emsi[, mamotivacion[1]]~df.emsi$Faku)
kruskal.test(df.itemak.emsi[, mamotivacion[2]]~df.emsi$Faku)
kruskal.test(df.itemak.emsi[, mamotivacion[3]]~df.emsi$Faku)
kruskal.test(df.itemak.emsi[, mamotivacion[4]]~df.emsi$Faku)
